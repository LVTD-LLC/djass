...
GRANT_PRO_MEMBERSHIP_ON_SIGNUP = env.bool("GRANT_PRO_MEMBERSHIP_ON_SIGNUP", default=True)
...
STRIPE_ONE_TIME_AMOUNT_CENTS = env.int("STRIPE_ONE_TIME_AMOUNT_CENTS", default=99900)
STRIPE_PRICE_IDS = {
